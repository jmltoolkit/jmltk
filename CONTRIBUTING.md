...
- As a fork of JavaParser you can find interesting information on their [wiki](https://github.com/javaparser/javaparser/wiki).
- Be sure to check [the coding guidelines](https://jmltoolkit.github.com/devel/coding-guidelines) which are
