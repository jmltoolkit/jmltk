...
public class CloneVisitor implements GenericVisitor<Visitable, Object> {
    ...
    public Visitable visit(final JmlSignalsClause n, final Object arg) {
        ...
        Comment comment = cloneNode(n.getComment(), arg);
        JmlSignalsClause r = new JmlSignalsClause(n.getTokenRange().orElse(null), null, name, parameter, expression);
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
    ...
    public Visitable visit(final JmlSignalsOnlyClause n, final Object arg) {
        ...
        Comment comment = cloneNode(n.getComment(), arg);
        JmlSignalsOnlyClause r = new JmlSignalsOnlyClause(n.getTokenRange().orElse(null),null, types);
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
    ...
    public Visitable visit(final JmlCallableClause n, final Object arg) {
        ...
        Comment comment = cloneNode(n.getComment(), arg);
        JmlCallableClause r = new JmlCallableClause(n.getTokenRange().orElse(null), null, name, methodSignatures);
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
    ...
    public Visitable visit(final JmlForallClause n, final Object arg) {
        ...
        Comment comment = cloneNode(n.getComment(), arg);
        JmlForallClause r = new JmlForallClause(n.getTokenRange().orElse(null), null, boundedVariables);
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
    ...
    public Visitable visit(final JmlConditionalClause n, final Object arg) {
        ...
        JmlConditionalClause r =
                new JmlConditionalClause(n.getTokenRange().orElse(null), n.getKind(), name, condition,  expression);
        r.setComment(comment);
        n.getOrphanComments().stream().map(Comment::clone).forEach(r::addOrphanComment);
        copyData(n, r);
        return r;
