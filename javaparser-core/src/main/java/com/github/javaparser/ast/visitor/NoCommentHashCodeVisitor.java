...
public class NoCommentHashCodeVisitor implements GenericVisitor<Integer, Void> {
    ...
    public Integer visit(final JmlContract n, final Void arg) {
        return (n.getBehavior().isPresent() ? n.getBehavior().get().accept(this, arg) : 0) * 31
    ...
    public Integer visit(final KeyCcatchBreak n, final Void arg) {
        return (n.getBlock().isPresent() ? n.getBlock().get().accept(this, arg) : 0) * 31
                + (n.getLabel().isPresent() ? n.getLabel().get().accept(this, arg) : 0);
    }
    ...
    public Integer visit(final KeyCcatchParameter n, final Void arg) {
        return (n.getBlock().isPresent() ? n.getBlock().get().accept(this, arg) : 0) * 31
                + (n.getParameter().isPresent() ? n.getParameter().get().accept(this, arg) : 0);
    }
    ...
    public Integer visit(final KeyContextStatementBlock n, final Void arg) {
        return (n.getContext().isPresent() ? n.getContext().get().accept(this, arg) : 0) * 31
                ...
                + (n.getStatements().accept(this, arg)) * 31
                + (n.getTr().isPresent() ? n.getTr().get().accept(this, arg) : 0);
    }
    ...
    public Integer visit(final KeyTypeSV n, final Void arg) {
        return (n.getText().hashCode()) * 31 + (n.getAnnotations().accept(this, arg));
    }
