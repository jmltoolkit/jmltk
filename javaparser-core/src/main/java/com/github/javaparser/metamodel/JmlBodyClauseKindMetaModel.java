...
public class JmlBodyClauseKindMetaModel extends JmlKeywordNodeMetaModel {

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    JmlBodyClauseKindMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(
                superBaseNodeMetaModel,
                JmlBodyClauseKind.class,
                "JmlBodyClauseKind",
