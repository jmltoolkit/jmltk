...
public class JmlContractBehaviorMetaModel extends JmlKeywordNodeMetaModel {

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    JmlContractBehaviorMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(
