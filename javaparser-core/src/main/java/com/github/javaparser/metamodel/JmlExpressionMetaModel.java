...
public class JmlExpressionMetaModel extends ExpressionMetaModel {
    ...
    JmlExpressionMetaModel(Optional<BaseNodeMetaModel> superBaseNodeMetaModel) {
        super(superBaseNodeMetaModel, JmlExpression.class, "JmlExpression", "com.github.javaparser.ast.jml.expr", true, false);
    }

    @Generated("com.github.javaparser.generator.metamodel.NodeMetaModelGenerator")
    protected JmlExpressionMetaModel(Optional<BaseNodeMetaModel> superNodeMetaModel, Class<? extends Node> type, String name, String packageName, boolean isAbstract, boolean hasWildcard) {
