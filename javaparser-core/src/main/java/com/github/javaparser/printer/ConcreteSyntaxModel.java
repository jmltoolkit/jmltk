...
public class ConcreteSyntaxModel {
    ...
    static {
        ...
        concreteSyntaxModelByClass.put(JmlInfFlowClause.class, sequence(attribute(KIND), attribute(EXPRESSIONS), attribute(EXPRESSIONS), token(GeneratedJavaParserConstants.BY), attribute(BY), token(GeneratedJavaParserConstants.DECLASSIFIES), attribute(ObservableProperty.DECLASSIFIES), token(GeneratedJavaParserConstants.ERASES), attribute(ObservableProperty.ERASES), token(GeneratedJavaParserConstants.NEW_OBJECTS), attribute(ObservableProperty.NEW_OBJECTS), semicolon(), newline()));
        // endregion
        // region KEY
